/******************************************************************************
 *
 * Module Name:  hk.hkjc.yzh.schema.test.jibx - ObjectFactory.java
 * Version: 1.0.0
...
import hk.hkjc.yzh.schema.test.jibx.chuanorderv1.ChuanItemType;
import hk.hkjc.yzh.schema.test.jibx.chuanorderv1.ChuanOrder;
import hk.hkjc.yzh.schema.test.jibx.chuanorderv1.Country;
import hk.hkjc.yzh.schema.test.jibx.chuanorderv1.Postaddr;
import hk.hkjc.yzh.schema.test.jibx.shiporderv1.CTshiporder;
import hk.hkjc.yzh.schema.test.jibx.shiporderv1.CountryType;
import hk.hkjc.yzh.schema.test.jibx.shiporderv1.Itemtype;
import hk.hkjc.yzh.schema.test.jibx.shiporderv1.Shiptotype;
...
public class ObjectFactory {
    public static CTshiporder createCTshiporder(String orderid) {
        ...
        order.setUpdateTime("2016-05-31");
