...
public class LoginAuthServerHandler extends SimpleChannelInboundHandler<SubscribeReq> {
    private static Map<String, Boolean> nodeCheck = new ConcurrentHashMap<String, Boolean>();
    private final Logger logger = LoggerFactory.getLogger(LoginAuthServerHandler.class);
