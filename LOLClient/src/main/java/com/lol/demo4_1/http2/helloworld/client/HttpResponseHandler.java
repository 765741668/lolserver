 ...
 * the License.
 */
package com.lol.demo4_1.http2.helloworld.client;
...
public class HttpResponseHandler extends SimpleChannelInboundHandler<FullHttpResponse> {
     ...
     * @see com.lol.demo4_1.http2.helloworld.client.HttpResponseHandler#awaitResponses(long, java.util.concurrent.TimeUnit)
     */
     ...
     * @see com.lol.demo4_1.http2.helloworld.client.HttpResponseHandler#put(int, io.netty.channel.ChannelFuture, io.netty.channel.ChannelPromise)
     */
