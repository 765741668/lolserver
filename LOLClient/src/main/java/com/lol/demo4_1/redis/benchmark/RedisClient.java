...
public class RedisClient {
    private static final String HOST = System.getProperty("host", "192.168.1.212");
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            Long counter = 100L;
            RedisClientHandler redisClientHandler = new RedisClientHandler(counter);
            ...
            for (; ; ) {
                ...
                String[] s = line.split(" ");
                counter = s.length == 3 && s[2] != null ? Integer.parseInt(s[2]) : counter;
                redisClientHandler.reSetCounter(counter);
