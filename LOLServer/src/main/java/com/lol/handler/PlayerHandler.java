...
//        logger.info("PlayerHandler-有客户端连接了 : {}", ctx.channel().remoteAddress());
//    }
//
//    @Override
...
//        GameUpBuffer msg = Utils.packgeUpData(ctx.attr(Constans.conn).get(), Protocol.TYPE_PLYAER, PlayerProtocol.OFFLINE_CREQ, PlayerProtocol.OFFLINE_CREQ, tempMessage);
