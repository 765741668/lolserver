...
//        logger.info("MatchHandler-有客户端连接了 : {}", ctx.channel().remoteAddress());
//    }
//
//
//    @Override
...
//
//        GameUpBuffer msg = Utils.packgeUpData(ctx.attr(Constans.conn).get(), Protocol.TYPE_MATCH, MatchProtocol.LEAVE_CREQ, MatchProtocol.LEAVE_CREQ, tempMessage);
