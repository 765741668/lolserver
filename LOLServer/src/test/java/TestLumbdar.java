...
public class TestLumbdar {
    ...
    public static void main(String[] args) {
        ...
        Consumer<String> cu = TestLumbdar::setSomething;
        cu.accept("this is Consumer ,it will process logic and nothing return");
        Consumer<String> cu22 = TestLumbdar::setSomething;
        cu22.accept("this is Consumer ,it will process logic and nothing return");


        System.out.println("~~~~~~~~~~~~~~~~~~~~~11~~~~~~~~~~~~~~~~~~~~~~~~");
        //Consumer: call accept to set input arg and  return void with one input argument 
        Consumer<String> cu2 = (aaa) -> setSomething2();
        cu2.accept(null);
        ...
        //Supplier:call getAcountId to return input arg type
        ...
        VoidNoArgInterface3<String> v4 = (x) -> getSomething2(x);
        v4.doSomething("a");

        System.out.println("~~~~~~~~~~~~~~~~~~~~~~~10~~~~~~~~~~~~~~~~~~~~~~");
        VoidNoArgInterface4<String> v5 = (x, y) -> setSomething(x, y);
        v5.doSomething("a", "b");
    ...
    @FunctionalInterface
    interface VoidNoArgInterface4<String> {
